...
parser.add_argument("--LR_path", type = str, default = '../custom_dataset_cars/train_LR/')
parser.add_argument("--GT_path", type = str, default = '../custom_dataset_cars/train_HR/')
...
parser.add_argument("--pre_train_epoch", type = int, default = 1500)
